...
<body class="font-sans text-gray-800">
    <header class="bg-black">
        <div class="h-[620px] max-w-screen-lg relative px-4 pt-4 pb-12 mx-auto flex flex-col gap-24 lg:px-8">
            ...
            <div class="absolute bottom-6 left-6 w-4 h-4 rounded-sm bg-gradient-to-r from-kobi-300/70 to-gray-600/70"></div>
        </div>
    </header>
    ...
    <!-- Tu enfoque, tu narrativa, tu realidad -->
    <section class="bg-gradient-to-tl from-kobi-200/70 py-16">
        <div class="relative max-w-screen-lg px-4 mx-auto flex flex-col items-center">
    ...
    <!-- Tu marca a otro nivel -->
    <section class="py-16">
        <div class="max-w-screen-lg px-4 mx-auto flex flex-col justify-center items-center">
            <h2 class="text-3xl text-center mb-4">Tu marca a <span class="font-bold">otro nivel</span></h2>
    ...
    <!-- Nuestro equipo -->
    <section class="max-w-screen-lg mx-auto px-4 sm:px-6 lg:px-4 py-16">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div class="w-full bg-gray-100 rounded-lg sahdow-lg overflow-hidden flex flex-col justify-center items-center">
                <div>
                    <img class="object-center object-cover h-auto w-full filter grayscale" src="./img/profiles/belen_3-2.jpg" alt="photo">
                </div>
            ...
            <div class="w-full bg-gray-100 rounded-lg sahdow-lg overflow-hidden flex flex-col justify-center items-center">
                <div>
                    <img class="object-center object-cover h-auto w-full filter grayscale" src="./img/profiles/dagma_3-2.jpg" alt="photo">
                </div>
                <div class="text-center py-8 sm:py-6">
            ...
            <div class="w-full bg-gray-100 rounded-lg sahdow-lg overflow-hidden flex flex-col justify-center items-center">
                <div>
                    <img class="object-center object-cover h-auto w-full filter grayscale" src="./img/profiles/edu_3-2.jpg" alt="photo">
                </div>
                <div class="text-center py-8 sm:py-6">
            ...
            <div class="w-full bg-gray-100 rounded-lg sahdow-lg overflow-hidden flex flex-col justify-center items-center">
                <div>
                    <img class="object-center object-cover h-auto w-full filter grayscale" src="./img/profiles/gusta_3-2.jpg" alt="photo">
                </div>
                <div class="text-center py-8 sm:py-6">
